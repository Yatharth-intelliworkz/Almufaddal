                   ...
                   <a href="./index.php"> <img src="./images/ft_logo.svg" alt="logo" class=" foot_logo img-fluid"></a>
                    ...
                    <div class="ft_right_con">
                        ...
                        <div class="d-flex gap-2 social-item">
                            <img src="./images/ft_mail.svg" alt="mail" width="24" height="24">
                            <a href="mailto:sales@almufaddal.ae" target="_blank"
                                class="text-white">sales@almufaddal.ae</a>
                        </div>
                    </div>
                    <div class="d-flex gap-3 justify-content-md-start justify-content-center">
                        <a href="#" target="_blank">
                            <img src="./images/ft_linkedin.svg" alt="linkedin">
                        </a>
                        <a href="#" target="_blank">
                            <img src="./images/ft_x.svg" alt="x">
                        </a>
                        <a href="#" target="_blank">
                            <img src="./images/ft_fb.svg" alt="facebook">
                        </a>
                        <a href="#" target="_blank">
                            <img src="./images/ft_insta.svg" alt="insta">
                        </a>
                    </div>
                </div>
            </div>
