...
<section class="hero_section">
    <div class="hero_slider">
        <div class="hero_slide">
            <img src="./images/hero_slide_img1.jpg" alt="" class="">
            <div class="ym_container position-absolute">
                <div class="hero_content">
                    <div class="row">
                        <div class="col-lg-8">
                            <h1 class="hero_slide_head">Reliable Industrial <br> Solutions for Maximum <br>
                                Efficiency</h1>
                            <p class="text-white">
                                At Al Mufaddal Engineering & Marine Services, we specialize in delivering top-tier
                                boiler maintenance, heat exchanger repairs, refractory solutions, and industrial
                                automation to keep your operations running at peak performance. Serving the Marine,
                                Oil & Gas, and Power Plant industries, we ensure reliability, safety, and efficiency
                                in every project.
                            </p>
                            <a href="javascript:void(0)" class="main_btn">Explore Our Services
                                <span class="btn_svg">
    ...
    <div class="custom-nav">
        <a class="prev">
            <img src="./images/slider_leftarrow.svg" alt="" class="img-fluid">
        </a>
        <a class="next">
                ...
                <div class="service_slide">
                    <div class="serv_slid_wrapper">
                        <div class="serv_slid_image bd_radius">
                            <img src="./images/service_boiler.png" alt="" class="img-fluid">
...
<section class="process">
    <div class="ym_container">
        <div class="row mb-4">
            ...
            <div class="col-lg-12">
                <p>At Al Mufaddal, we follow a structured and transparent process to ensure your projects are completed
                    on time, within budget, and to the highest standards. From initial consultation to final handover,
                    we prioritize efficiency, safety, and client satisfaction. At Al Mufaddal, we follow a structured
    ...
    <div class="ym_container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="main_head">Maximize Efficiency, Minimize Downtime.</h2>
                <p>We deliver end-to-end solutions for industrial boilers and heat exchangers, ensuring maximum
                    efficiency, safety, and reliability. Our expert services in Manufacturing, Repairs, and Maintenance
                    are tailored for the Marine, Oil & Gas, and Power Plant industries. With a focus on innovation and
                    excellence, we help you maintain seamless operations and extend the lifespan of your equipment.</p>
                <div class="text-center">
                    <a href="javascript:void(0)" class="main_btn d-inline-block">Request a Consultation
                        <span class="btn_svg">
                            <img src="./images/blue_gear.svg" alt="" class="img-fluid">
                        </span>
                    </a>
